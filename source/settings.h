...
namespace Config {
	enum Key {
		...
		// Procedural Generation - Island
		PROCEDURAL_MAP_WIDTH,
		PROCEDURAL_MAP_HEIGHT,
		PROCEDURAL_ISLAND_SIZE,
		PROCEDURAL_ISLAND_FALLOFF,
		PROCEDURAL_ISLAND_THRESHOLD,
		PROCEDURAL_NOISE_SCALE,
		PROCEDURAL_NOISE_OCTAVES,
		PROCEDURAL_NOISE_PERSISTENCE,
		PROCEDURAL_NOISE_LACUNARITY,
		PROCEDURAL_CLEANUP_ENABLED,
		PROCEDURAL_MIN_LAND_PATCH,
		PROCEDURAL_MAX_WATER_HOLE,
		PROCEDURAL_SMOOTHING_PASSES,
		PROCEDURAL_WATER_ID,
		PROCEDURAL_GROUND_ID,

		// Procedural Generation - Dungeon
		PROCEDURAL_DNG_WIDTH,
		PROCEDURAL_DNG_HEIGHT,
		PROCEDURAL_DNG_WALL_ID,
		PROCEDURAL_DNG_FLOOR_ID,
		PROCEDURAL_DNG_ROOM_COUNT,
		PROCEDURAL_DNG_MIN_ROOM_SIZE,
		PROCEDURAL_DNG_MAX_ROOM_SIZE,
		PROCEDURAL_DNG_CORRIDOR_WIDTH,
		PROCEDURAL_DNG_GENERATE_CAVES,
